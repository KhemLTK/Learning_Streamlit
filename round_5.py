...
if uploaded_file:
    ...
    st.dataframe(upper_df.merge(lower_df.drop(columns=["Brush Number"]), left_index=True, right_index=True).style.format("{:.6f}"), use_container_width=True)

    # === Plot 1: Combined Avg Rate
    ...
    # === Plot 4: Remaining Life Estimate
